...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Parse DMARC .gz compressed XML reports.")
    parser.add_argument('--verbose', '-v', action='store_true', default=0, help="Show passes in addition to fails.")
    parser.add_argument('files', nargs='+', help="The paths to one or more DMARC .gz compressed XML files.")
